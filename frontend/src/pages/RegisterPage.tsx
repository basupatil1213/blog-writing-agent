...
export function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-950 via-brand-900 to-slate-900 flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="px-8 pt-8 pb-6">
            <h1 className="text-xl font-bold text-slate-900 mb-6">Get started</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className="block text-sm font-semibold text-slate-700">
                  Username <span className="font-normal text-slate-400">(letters, numbers, - _)</span>
                </label>
                <input
                  type="text"
                  required
              ...
              <div className="space-y-1.5">
                <label className="block text-sm font-semibold text-slate-700">
                  Password <span className="font-normal text-slate-400">(min 8 chars, 1 digit)</span>
                </label>
                <input
                  type="password"
                  required
